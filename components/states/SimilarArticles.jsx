...
constructor(props){
  ...
  this.state={
    ...
    mainTopic: this.props.mainHeader,
    subTopic: this.props.subHeader,
  }
   this.sortByTopic = this.sortByTopic.bind(this);
}
...
componentDidMount(){
   window.scrollTo({ top: 0, behavior: "smooth" })
    this.sortByTopic(window.articleModels.articleListModel())
  }
...
//.filter( item => item.subHeader.toString()===this.state.subTopic.toString())